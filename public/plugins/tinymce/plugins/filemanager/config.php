...
//$root = rtrim('/home/htv2/public_html','/')."/"; // don't touch this configuration
...
$upload_dir = 'editor_images/'; // path from base_url to upload base dir
$thumbs_dir = "thumbs/";
$current_path = dirname(__FILE__).'/../../../../'.$upload_dir; // relative path from filemanager folder to upload files folder
$abs_root_path = dirname(__FILE__).'/../../../../';
$relative_path = "/".$upload_dir;

$MaxSizeUpload=300; //Mb
